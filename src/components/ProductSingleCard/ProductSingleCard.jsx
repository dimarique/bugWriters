...
import heart_filled2 from "../../assets/heart_filled2.svg";
    ...
    <div className={`${styles.productSignleCard_container} side_padding`}>
      <div className={styles.productSignleCard_header}>
        ...
        <img
          ...
          src={isFav ? heart_favorite : heart_filled2}
          alt="heard image"
        />
      </div>
      <div className={styles.productSingleCard_img_price_button}>
        ...
        <div className={styles.productSingleCard_price_button}>
          ...
          <div className={styles.productSingleCard_price}>
            ...
            {discont_price && (
              <div
                className={`${styles.productSingleCard_sale_label} ${styles.productSignleCard_sale_label2}`}
              >
                <p>- {Math.floor(((price - discont_price) / price) * 100)}%</p>
              </div>
            )}
          ...
          <div className={styles.productSignleCard_quantButton}>
            <div className={styles.productSingleCard_quantity}>
              <button
                onClick={() => setQuantity((qua) => Math.max(1, qua - 1))}
              >
                -
              </button>
              <span>{quantity}</span>
          ...
          <div
            className={`${styles.productSingleCard_description} ${styles.productSingleCard_description2}`}
          >
            <h3>Description</h3>
      ...
      {ModalOpen && (
        <div
          className={styles.productSingleCard_modal}
